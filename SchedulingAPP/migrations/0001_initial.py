# Generated by Django 4.1.2 on 2022-12-22 02:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('days', models.CharField(choices=[('Monday', 'Monday'), ('Tuesday', 'Tuesday'), ('Wednesday', 'Wednesday'), ('Thursday', 'Thursday'), ('Friday', 'Friday'), ('Monday Wednesday', 'Monday Wednesday'), ('Monday Wednesday Friday', 'Monday Wednesday Friday'), ('Tuesday Thursday', 'Tuesday Thursday')], default='Monday', max_length=23)),
